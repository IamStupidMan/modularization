 ...
 *     author: Summer
 *     time  : 2016/08/02
 *     desc  : utils about StatusBar
 * </pre>
 */
public class StatusBarUtil {

    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.common_status_bar_util_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.common_status_bar_util_translucent_view;
